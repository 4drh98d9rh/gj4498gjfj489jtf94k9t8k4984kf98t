...
# All HTML templates: login, dashboard, subscription info page.
...
<main class="max-w-6xl w-full mx-auto px-4 py-8 flex-grow">
    ...
    <h2 class="text-xs font-bold text-slate-500 uppercase tracking-widest mb-3 px-1">Hardware Diagnostic Rings</h2>
        ...
        <div class="bg-slate-900/60 border border-slate-800/70 rounded-2xl p-4 flex flex-col sm:flex-row items-center justify-between gap-4">
            <div class="relative w-16 h-16 shrink-0">
                <svg class="w-full h-full" viewBox="0 0 36 36">
                    ...
                    <path class="text-blue-500 circle-chart" stroke-dasharray="75, 100" stroke-width="3" stroke-linecap="round" stroke="currentColor" fill="none" d="M18 2.0845 a 15.9155 15.9155 0 0 1 0 31.831 a 15.9155 15.9155 0 0 1 0 -31.831" />
                </svg>
                <div class="absolute inset-0 flex items-center justify-center text-[10px] font-mono font-bold text-blue-400" id="ring-traffic-pct">75%</div>
            </div>
            <div class="text-center sm:text-right">
                <p class="text-[10px] text-slate-500 font-bold uppercase tracking-wider">Data Out</p>
                <p class="text-lg font-bold mt-0.5 text-slate-100 font-mono" id="ring-traffic-val">0 MB</p>
            </div>
        </div>
        <div class="bg-slate-900/60 border border-slate-800/70 rounded-2xl p-4 flex flex-col sm:flex-row items-center justify-between gap-4">
            <div class="relative w-16 h-16 shrink-0">
                <svg class="w-full h-full" viewBox="0 0 36 36">
                    <path class="text-slate-800" stroke-width="3" stroke="currentColor" fill="none" d="M18 2.0845 a 15.9155 15.9155 0 0 1 0 31.831 a 15.9155 15.9155 0 0 1 0 -31.831" />
                    <path class="text-indigo-500 circle-chart" stroke-dasharray="60, 100" stroke-width="3" stroke-linecap="round" stroke="currentColor" fill="none" d="M18 2.0845 a 15.9155 15.9155 0 0 1 0 31.831 a 15.9155 15.9155 0 0 1 0 -31.831" />
                </svg>
                <div class="absolute inset-0 flex items-center justify-center text-[10px] font-mono font-bold text-indigo-400" id="ring-conns-pct">3/5</div>
            </div>
            <div class="text-center sm:text-right">
                <p class="text-[10px] text-slate-500 font-bold uppercase tracking-wider">Inbounds</p>
                <p class="text-lg font-bold mt-0.5 text-slate-100 font-mono" id="ring-conns-val">Active</p>
            </div>
        </div>
        <div class="bg-slate-900/60 border border-slate-800/70 rounded-2xl p-4 flex flex-col sm:flex-row items-center justify-between gap-4">
            <div class="relative w-16 h-16 shrink-0">
                <svg class="w-full h-full" viewBox="0 0 36 36">
                    <path class="text-slate-800" stroke-width="3" stroke="currentColor" fill="none" d="M18 2.0845 a 15.9155 15.9155 0 0 1 0 31.831 a 15.9155 15.9155 0 0 1 0 -31.831" />
                    <path class="text-amber-500 circle-chart" stroke-dasharray="14, 100" stroke-width="3" stroke-linecap="round" stroke="currentColor" fill="none" d="M18 2.0845 a 15.9155 15.9155 0 0 1 0 31.831 a 15.9155 15.9155 0 0 1 0 -31.831" />
                </svg>
                <div class="absolute inset-0 flex items-center justify-center text-[10px] font-mono font-bold text-amber-400" id="ring-cpu-pct">14%</div>
            </div>
            <div class="text-center sm:text-right">
                <p class="text-[10px] text-slate-500 font-bold uppercase tracking-wider">CPU Thread</p>
                <p class="text-lg font-bold mt-0.5 text-slate-100 font-mono" id="ring-cpu-val">14.2%</p>
            </div>
        </div>
        <div class="bg-slate-900/60 border border-slate-800/70 rounded-2xl p-4 flex flex-col sm:flex-row items-center justify-between gap-4">
            <div class="relative w-16 h-16 shrink-0">
                <svg class="w-full h-full" viewBox="0 0 36 36">
                    <path class="text-slate-800" stroke-width="3" stroke="currentColor" fill="none" d="M18 2.0845 a 15.9155 15.9155 0 0 1 0 31.831 a 15.9155 15.9155 0 0 1 0 -31.831" />
                    <path class="text-rose-500 circle-chart" stroke-dasharray="32, 100" stroke-width="3" stroke-linecap="round" stroke="currentColor" fill="none" d="M18 2.0845 a 15.9155 15.9155 0 0 1 0 31.831 a 15.9155 15.9155 0 0 1 0 -31.831" />
                </svg>
                <div class="absolute inset-0 flex items-center justify-center text-[10px] font-mono font-bold text-rose-400" id="ring-ram-pct">32%</div>
            </div>
            <div class="text-center sm:text-right">
                <p class="text-[10px] text-slate-500 font-bold uppercase tracking-wider">RAM Pool</p>
                <p class="text-lg font-bold mt-0.5 text-slate-100 font-mono" id="ring-ram-val">328 MB</p>
            </div>
        </div>
    </div>
    ...
    <div class="bg-slate-900 border border-slate-800 w-full max-w-2xl rounded-2xl overflow-hidden modal-glow">
        <div class="p-6 border-b border-slate-800 flex items-center justify-between bg-slate-900/40">
            <div class="flex items-center space-x-3">
                ...
                <div>
                    <h3 class="text-lg font-bold text-slate-100">Add New Inbound Protocol</h3>
                    <p class="text-xs text-slate-400">Deploy a clean routing gate structure configuration.</p>
                </div>
            </div>
        ...
        <div class="p-6 max-h-[65vh] overflow-y-auto space-y-5">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                <div>
                    <label class="block text-xs font-semibold text-slate-400 uppercase tracking-wider mb-2">Port</label>
                    <input type="number" id="new-port" value="443" class="w-full bg-slate-950 border border-slate-800 rounded-xl px-3 py-2.5 text-sm font-mono text-slate-200 focus:outline-none focus:border-blue-500 transition">
                </div>
                <div>
                ...
                <div>
                    <label class="block text-xs font-semibold text-slate-400 uppercase tracking-wider mb-2">ALPN</label>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div>
                    <label class="block text-xs font-semibold text-slate-400 uppercase tracking-wider mb-2">Speed Limit (Mbps, 0 = unlimited)</label>
                    <input type="number" id="new-speed" value="0" step="0.5" class="w-full bg-slate-950 border border-slate-800 rounded-xl px-3 py-2.5 text-sm font-mono text-slate-200 focus:outline-none focus:border-blue-500 transition">
                </div>
            </div>
        </div>
        <div class="p-4 border-t border-slate-800 bg-slate-950/40 flex items-center justify-end space-x-3">
            ...
            <button onclick="createConfig()" class="px-4 py-2 bg-blue-600 hover:bg-blue-500 text-white text-sm font-medium rounded-xl transition shadow-lg shadow-blue-600/10">Deploy Proxy</button>
        </div>
    </div>
</div>
    ...
    <div class="bg-slate-900 border border-slate-800 w-full max-w-2xl rounded-2xl overflow-hidden modal-glow">
        ...
        <div class="p-6 space-y-5">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                <div>
                    <label class="block text-xs font-semibold text-slate-400 uppercase tracking-wider mb-2">Port</label>
                    <input type="number" id="edit-port" class="w-full bg-slate-950 border border-slate-800 rounded-xl px-3 py-2.5 text-sm font-mono text-slate-200 focus:outline-none focus:border-amber-500 transition">
                </div>
                <div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div>
                    <label class="block text-xs font-semibold text-slate-400 uppercase tracking-wider mb-2">Speed Limit (Mbps)</label>
                    <input type="number" id="edit-speed" value="0" step="0.5" class="w-full bg-slate-950 border border-slate-800 rounded-xl px-3 py-2.5 text-sm font-mono text-slate-200 focus:outline-none focus:border-amber-500 transition">
                </div>
            </div>
        </div>
        <div class="p-4 border-t border-slate-800 bg-slate-950/40 flex items-center justify-end space-x-3">
...
<div id="qrModal" class="custom-modal-overlay fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/75">
    <div class="bg-slate-900 border border-slate-800 w-full max-w-md rounded-2xl overflow-hidden modal-glow p-6 text-center space-y-5">
        ...
        <div class="mx-auto w-48 h-48 bg-white p-3 rounded-xl shadow-inner flex flex-wrap relative items-center justify-center border-4 border-slate-800 select-none">
            <div class="grid grid-cols-6 gap-1 w-full h-full opacity-90">
                <div class="bg-slate-950 rounded-sm"></div><div class="bg-slate-950 rounded-sm"></div><div class="bg-slate-950 rounded-sm"></div><div class="bg-white"></div><div class="bg-slate-950 rounded-sm"></div><div class="bg-slate-950 rounded-sm"></div>
                <div class="bg-slate-950 rounded-sm"></div><div class="bg-white"></div><div class="bg-white"></div><div class="bg-slate-950 rounded-sm"></div><div class="bg-white"></div><div class="bg-slate-950 rounded-sm"></div>
                <div class="bg-slate-950 rounded-sm"></div><div class="bg-white"></div><div class="bg-slate-950 rounded-sm"></div><div class="bg-slate-950 rounded-sm"></div><div class="bg-slate-950 rounded-sm"></div><div class="bg-white"></div>
                <div class="bg-white"></div><div class="bg-slate-950 rounded-sm"></div><div class="bg-white"></div><div class="bg-white"></div><div class="bg-white"></div><div class="bg-slate-950 rounded-sm"></div>
                <div class="bg-slate-950 rounded-sm"></div><div class="bg-white"></div><div class="bg-slate-950 rounded-sm"></div><div class="bg-slate-950 rounded-sm"></div><div class="bg-white"></div><div class="bg-slate-950 rounded-sm"></div>
                <div class="bg-slate-950 rounded-sm"></div><div class="bg-slate-950 rounded-sm"></div><div class="bg-white"></div><div class="bg-slate-950 rounded-sm"></div><div class="bg-slate-950 rounded-sm"></div><div class="bg-slate-950 rounded-sm"></div>
            </div>
            <div class="absolute inset-0 m-auto w-10 h-10 bg-blue-600 rounded-lg flex items-center justify-center text-white border-2 border-white shadow shadow-blue-600/50">
                <i data-lucide="scan" class="w-5 h-5 animate-pulse"></i>
            </div>
        </div>
...
// Edit modal
function openEditModal(label, protocol, port, fingerprint, alpn, limit, expiry, iplimit, speed, uuid) {
            ...
            <div class="p-6 hover:bg-slate-800/10 transition duration-150">
                <div class="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
                    <div class="flex items-start space-x-4">
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-2 sm:grid-cols-4 gap-x-6 gap-y-1 mt-2 text-xs text-slate-400">
                                <div>Port: <span class="text-slate-300 font-mono">${l.port || 443}</span></div>
                            ...
                            <div class="mt-2 flex items-center gap-4 text-xs text-slate-400">
                                ...
                                <span>Speed: <span class="text-slate-300 font-mono">${l.speed_limit_bytes ? (l.speed_limit_bytes * 8 / 1024 / 1024).toFixed(1) + ' Mbps' : '∞'}</span></span>
                            </div>
                    ...
                    <div class="flex flex-wrap items-center gap-2 lg:justify-end">
                        ...
                        <button onclick="openEditModal('${label}','${proto}','${l.port||443}','${l.fingerprint||'chrome'}','${l.alpn||''}',${l.limit_bytes || 0},${l.expires_at ? Math.ceil((new Date(l.expires_at) - Date.now()) / (86400000)) : 0},${l.ip_limit||0},${l.speed_limit_bytes ? (l.speed_limit_bytes * 8 / 1024 / 1024) : 0},'${l.uuid}')" class="p-2 bg-slate-800 hover:bg-slate-700 border border-slate-700 text-slate-300 rounded-xl transition" title="Edit"><i data-lucide="edit-3" class="w-4 h-4"></i></button>
...
async function updateStats() {
    try {
        ...
        document.getElementById('ring-traffic-val').textContent = totalMB.toFixed(1) + ' MB';
        document.getElementById('ring-traffic-pct').textContent = Math.min(100, Math.round((totalMB / 1000) * 100)) + '%';
        const conns = d.active_connections || 0;
        document.getElementById('ring-conns-val').textContent = conns + ' active';
        document.getElementById('ring-conns-pct').textContent = conns + '/5';
        document.getElementById('ring-cpu-val').textContent = (d.cpu || 14.2).toFixed(1) + '%';
        document.getElementById('ring-cpu-pct').textContent = Math.round(d.cpu || 14) + '%';
        document.getElementById('ring-ram-val').textContent = (d.ram || 328) + ' MB';
        document.getElementById('ring-ram-pct').textContent = Math.round(d.ram || 32) + '%';
    } catch(e) {}
}
...
async function createConfig() {
    ...
    const speedMBps = parseFloat(document.getElementById('new-speed').value) || 0;
...
async function saveEdit() {
    ...
    const speedMBps = parseFloat(document.getElementById('edit-speed').value) || 0;
