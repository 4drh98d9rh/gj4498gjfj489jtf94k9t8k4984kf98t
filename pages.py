...
<div id="qrModal" class="custom-modal-overlay fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/75">
    <div class="bg-slate-900 border border-slate-800 w-full max-w-3xl rounded-2xl overflow-hidden modal-glow p-6 space-y-5">
        <div class="flex items-center justify-between border-b border-slate-800 pb-3">
            <div class="flex items-center gap-3">
                ...
                <div class="relative">
                    <svg version="1.0" xmlns="http://www.w3.org/2000/svg" width="56" height="56" viewBox="0 0 512.000000 512.000000" preserveAspectRatio="xMidYMid meet">
  <g transform="translate(0.000000,512.000000) scale(0.100000,-0.100000)" fill="currentColor" stroke="none">
    ...
    -529 0 -535 22 -575 24 -46 54 -75 103 -101 33 -18 67 -19 570 -19 534 0 535 0
    577 22 53 29 98 84 112 139 7 28 11 214 11 537 0 554 -1 561 -67 629 -66 67 -72
    68 -637 67 -394 0 -510 -3 -545 -14z m779 -685 l0 -230 -230 0 -230 0 0 230 0
